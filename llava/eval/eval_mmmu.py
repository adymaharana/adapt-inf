...
from llava.eval.mmmu_utils import save_json, CAT_SHORT2LONG, DOMAIN_CAT2SUB_CAT
from llava.eval.mmmu_utils import evaluate, parse_multi_choice_response, parse_open_response, calculate_ins_level_acc
...
if __name__ == '__main__':
    ...
    results_dict[args.model_name]['mmmu'] = printable_results['Overall']["acc"]*100
