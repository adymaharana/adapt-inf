...
def eval_model(args):
    ...
    questions = json.load(open(os.path.expanduser(args.data_file), "r"))
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        score = calculate_bleu(target, outputs)
        # print(target, outputs, score)
        scores.append(score)
    ...
    results_dict[model_name][args.dataset] = sum(scores)/len(scores)
